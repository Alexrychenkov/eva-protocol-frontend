...
const ALLOCATIONS = [
  { label: 'Public Sale',           pct: 55, color: '#3d6bff', desc: 'Solana launch — fair and transparent distribution' },
  { label: 'Treasury',              pct: 20, color: '#6189ff', desc: 'Protocol operations and long-term development' },
  { label: 'Liquidity',             pct: 15, color: '#2a54e6', desc: 'DEX and CEX liquidity provisioning' },
  { label: 'Ecosystem',             pct: 10, color: '#58c7ff', desc: 'Integrations, partnerships, and incentive programs' },
]
...
function DonutChartInner({ animate }: { animate: boolean }) {
  ...
  return (
    <svg viewBox="0 0 200 200" className="w-full max-w-[260px] mx-auto" style={{ overflow: 'visible' }}>
      ...
      {/* Center label */}
      <text x="100" y="96" textAnchor="middle" fontSize="13" fontWeight="700" fill="#eef1f7">$EVA</text>
...
const STAT_PANELS = ['gl-metal-panel', 'gl-onyx-panel', 'gl-onyx-panel-b', 'gl-prism-panel']
...
export function TokenomicsPage() {
  ...
  return (
    <div className="min-h-screen relative gl-data-page" style={{ color: 'var(--text-primary)' }}>
      <LiquidBackdrop />
      <HeaderBar
      ...
      <main className="pt-16 relative z-10">
          ...
          >
            ...
            <div
              ...
              style={{
                ...
                boxShadow: 'inset 0 1px 0 rgba(255,255,255,0.05), inset 0 0 24px rgba(40,90,210,0.10), 0 8px 22px rgba(0,0,0,0.5)',
            ...
            >
              ...
              <span
                ...
                style={
                  EVA_SOLANA_MINT === 'TBA'
                    ...
                    : { background: 'rgba(61,107,255,0.12)', color: '#3d6bff', border: '1px solid rgba(61,107,255,0.24)' }
                }
              >
              ...
              >
                {copied ? <Check className="w-3.5 h-3.5" style={{ color: '#3d6bff' }} /> : <Copy className="w-3.5 h-3.5" style={{ color: 'var(--text-tertiary)' }} />}
              </button>
            </div>
          </motion.div>
        </section>
        ...
        <section className="px-4 pb-16 max-w-5xl mx-auto">
          ...
          >
            {[
              ...
              <div key={s.label} className={`rounded-2xl p-5 flex flex-col gap-1 overflow-hidden ${STAT_PANELS[i]}`}>
                <span className="text-[11px] uppercase tracking-widest font-medium" style={{ color: 'var(--text-tertiary)' }}>{s.label}</span>
                <span className="text-2xl font-bold gl-metal-text">{s.value}</span>
        ...
        <section className="px-4 pb-20 max-w-5xl mx-auto">
          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center" style={{ overflow: 'visible' }}>
              {/* Donut */}
              <motion.div
                  ...
                  >
                    <div className="flex items-center justify-between mb-1">
                      <div className="flex items-center gap-2">
                        <span
                          ...
                          style={{ background: a.color, boxShadow: `0 0 5px ${a.color}99` }}
                        />
                    ...
                    <div className="h-1.5 rounded-full overflow-hidden" style={{ background: 'rgba(255,255,255,0.04)' }}>
                      <motion.div
                        ...
                        style={{ background: `linear-gradient(90deg, ${a.color}, ${a.color}cc)`, boxShadow: `0 0 8px ${a.color}55` }}
                        initial={{ width: 0 }}
                    ...
                    <div
                      ...
                      style={{ top: 'calc(100% + 4px)', opacity: activeAlloc === i ? 1 : 0 }}
                    >
                      <span
                ...
                {VESTING.map((row, i) => {
                  ...
                  return (
                    <tr
                      ...
                      style={{ borderBottom: i < VESTING.length - 1 ? '1px solid var(--panel-border)' : 'none' }}
                      onMouseEnter={e => (e.currentTarget.style.background = 'rgba(70,100,180,0.10)')}
                      onMouseLeave={e => (e.currentTarget.style.background = 'transparent')}
                    >
                      <td className="px-5 py-3.5">
                        <div className="flex items-center gap-2">
                          <span className="w-2 h-2 rounded-full flex-shrink-0" style={{ background: alloc?.color ?? '#888', boxShadow: `0 0 7px ${alloc?.color ?? '#888'}` }} />
                      ...
                      <td className="px-5 py-3.5">
                        <span
                          ...
                          style={{
                            background: row.tge === '100%' ? 'rgba(61,107,255,0.14)' : 'rgba(88,199,255,0.12)',
            ...
            {UTILITY.map((u, i) => (
              ...
              >
                ...
                <div className="relative flex flex-col gap-1.5">
                  <div className="flex items-center gap-2">
                    <div className="w-1.5 h-1.5 rounded-full flex-shrink-0" style={{ background: u.color, boxShadow: `0 0 6px ${u.color}` }} />
          ...
          >
            ...
            <div className="flex flex-wrap items-center justify-center gap-3 flex-shrink-0">
              ...
              <button
                ...
                style={{
                  background: 'linear-gradient(180deg, #4f7bff 0%, #3d6bff 100%)',
                  color: '#fff',
                  boxShadow: '0 4px 16px rgba(61,107,255,0.4), inset 0 1px 0 rgba(255,255,255,0.25)',
                }}
              >
                Learn more
              </button>
