...
export function MetricTooltip({
  ...
  const tooltipContent = (
    ...
    >
      <div
        ...
        style={{
          background: 'linear-gradient(168deg, rgba(23,26,34,0.97) 0%, rgba(12,13,18,0.98) 100%)',
      ...
      >
        ...
        >
          <span
            ...
            style={{
              background: 'linear-gradient(180deg, rgba(61,107,255,0.18), rgba(61,107,255,0.05))',
              border: '1px solid rgba(61,107,255,0.24)',
              boxShadow: 'inset 0 1px 0 rgba(255,255,255,0.10), 0 0 12px rgba(61,107,255,0.22)',
            }}
          >
            <HugeiconsIcon icon={InformationCircleIcon} size={14} strokeWidth={1.9} style={{ color: '#9fbcff' }} />
          </span>
          <span className="gl-metal-text" style={{ fontWeight: 700, fontSize: '14px' }}>
            {name}
          </span>
        </div>
        ...
        <div
          className="mb-3"
          style={{
            background: 'linear-gradient(180deg, rgba(8,10,16,0.6), rgba(0,0,0,0.35))',
        ...
        >
          ...
          >
            <HugeiconsIcon icon={FunctionIcon} size={12} strokeWidth={1.9} style={{ color: '#9fbcff' }} />
        ...
        {/* Description */}
        <p style={{ fontSize: '12px', lineHeight: '1.55', color: 'var(--text-secondary)', margin: 0 }}>
          {description}
        </p>
      </div>
    </div>
  ...
  return (
    <>
      ...
      >
        <HugeiconsIcon icon={InformationCircleIcon} size={size} strokeWidth={1.9} />
      </button>
