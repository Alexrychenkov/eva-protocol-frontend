...
import { Login03Icon, UserAdd01Icon, Cancel01Icon, SquareLock02Icon, CheckmarkCircle01Icon } from '@hugeicons/core-free-icons'
          ...
          >
            ...
            <div className="gl-modal-head flex items-center gap-3">
              <div className="dash-ico shrink-0">
                <HugeiconsIcon icon={SquareLock02Icon} size={18} strokeWidth={1.9} />
              </div>
              <div className="min-w-0 flex-1">
                <h2 className="gl-modal-title gl-metal-text truncate">{t.title}</h2>
            ...
            <div className="gl-modal-foot flex flex-col gap-3">
              <a href="/login" className="gl-modal-btn-primary flex items-center justify-center gap-2 w-full py-3 px-4 rounded-xl font-semibold text-sm">
                <HugeiconsIcon icon={Login03Icon} size={18} strokeWidth={1.9} />
                {t.login}
              </a>

              <a href="/register" className="gl-modal-btn-ghost flex items-center justify-center gap-2 w-full py-3 px-4 rounded-xl font-semibold text-sm">
                <HugeiconsIcon icon={UserAdd01Icon} size={18} strokeWidth={1.9} />
                {t.register}
              </a>
