...
export default function HeaderBar({
  ...
  const handleLeaf = useCallback((leaf: NavLeaf) => {
  ...
  const spaGo = useCallback((e: MouseEvent, path: string) => {
    ...
    <nav className="fixed top-0 left-0 right-0 z-50">
      <div className="gl-navbar flex items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-1.5 shrink-0">
          <button onClick={goHome} className="gl-home-eva" aria-label={isEn ? 'Home' : '首页'}>
            EVA
          </button>
        </div>
        ...
        <div className="hidden md:flex items-center justify-between flex-1 pl-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <div
              ...
              style={{ background: 'linear-gradient(180deg, transparent 0%, rgba(61,107,255,0.45) 26%, rgba(61,107,255,0.45) 74%, transparent 100%)' }}
            />
            ...
            {isLoggedIn && user ? (
              <div className="relative" ref={userDropdownRef}>
                ...
                >
                  <span className="gl-user-avatar">{user.email[0].toUpperCase()}</span>
                  <span className="gl-user-email">{user.email}</span>
                  <HugeiconsIcon icon={ArrowDown01Icon} size={15} strokeWidth={2.2} className="gl-user-chev" />
                </button>
                  ...
                  <div className="gl-user-menu">
                    <div className="gl-user-menu-head">
                      ...
                      <div className="min-w-0">
                        <div className="gl-user-menu-label">{t('loggedInAs', language)}</div>
