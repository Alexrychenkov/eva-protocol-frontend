                ...
                return (
                  <li key={item.id}>
                    <button
                      ...
                      className={`w-full text-left px-3 py-2 rounded-lg text-sm transition-all border-l-[3px] flex items-start gap-2 ${isActive
                    ...
                    >
                      <span className="shrink-0 font-mono text-xs mt-0.5" style={{ color: 'var(--accent-primary)', opacity: 0.7 }}>{num}.</span>
