...
export function EquityChart({ traderId, embedded = false }: EquityChartProps) {
  ...
  if (isLoading) {
    return (
      <div className={embedded ? '' : 'gl-aurora-panel rounded-2xl overflow-hidden'}>
          ...
          <div className="text-center py-16" style={{ color: 'var(--text-secondary)' }}>
            <div className="mb-4 flex justify-center">
              <span className="dash-kpi-ico">
                <HugeiconsIcon icon={ChartLineData01Icon} size={28} strokeWidth={1.7} />
              </span>
            </div>
    ...
    if (active && payload && payload.length) {
      ...
      return (
        <div
          ...
          style={{
            background: 'linear-gradient(160deg, rgba(28,33,48,0.96), rgba(14,17,26,0.96))',
            border: '1px solid rgba(120,150,255,0.22)',
            boxShadow: '0 10px 30px rgba(0,0,0,0.55), inset 0 1px 0 rgba(255,255,255,0.06)',
            backdropFilter: 'blur(6px)',
          }}
        >
          <div className="text-[11px] mb-1 uppercase tracking-wider" style={{ color: 'var(--text-tertiary)' }}>
            Cycle #{data.cycle}
          </div>
          <div className="font-bold tabular-nums gl-metal-text" style={{ color: 'var(--text-primary)' }}>
  ...
  return (
    <div className={embedded ? '' : 'gl-aurora-panel rounded-2xl overflow-hidden animate-fade-in'}>
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between mb-4">
          ...
          {!embedded && (
            <div className="flex items-center gap-2.5 mb-3">
              <span className="dash-ico">
                <HugeiconsIcon icon={ChartLineData01Icon} size={16} strokeWidth={1.9} />
              </span>
              ...
              <span
                ...
                style={{
                  ...
                  boxShadow: `inset 0 1px 0 rgba(255,255,255,0.05), 0 2px 10px ${
                    isProfit ? 'rgba(14,203,129,0.12)' : 'rgba(246,70,93,0.12)'
                  }`,
                }}
              >
                <HugeiconsIcon
        ...
        <div className="gl-seg self-start sm:self-auto">
          ...
          >
            <HugeiconsIcon icon={DollarCircleIcon} size={15} strokeWidth={1.9} /> USDT
          </button>
          <button
            ...
            className="gl-seg-item flex items-center gap-1.5"
          >
            <HugeiconsIcon icon={PercentSquareIcon} size={15} strokeWidth={1.9} /> %
          </button>
        </div>
      </div>
      ...
      >
        ...
        <ResponsiveContainer width="100%" height={280}>
          ...
          >
            ...
            <CartesianGrid strokeDasharray="3 3" stroke="rgba(120,150,255,0.06)" vertical={false} />
            <XAxis
              dataKey="time"
            ...
            />
            <Tooltip content={<CustomTooltip />} cursor={{ stroke: '#3d6bff', strokeWidth: 1, strokeDasharray: '4 4', strokeOpacity: 0.5 }} />
            <ReferenceLine
