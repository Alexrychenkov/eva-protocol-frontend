          ...
          <div className="flex items-center gap-3 min-w-0">
            <div className="relative shrink-0">
              ...
              <div
                ...
                style={{
                  background: 'linear-gradient(180deg, rgba(61,107,255,0.22), rgba(61,107,255,0.06))',
                  border: '1px solid rgba(61,107,255,0.30)',
                  boxShadow: 'inset 0 1px 0 rgba(255,255,255,0.10), 0 0 10px rgba(61,107,255,0.30)',
                }}
              >
                <HugeiconsIcon icon={Robot01Icon} size={12} strokeWidth={2} style={{ color: '#9fbcff' }} />
              </div>
            </div>
            <div className="min-w-0">
              <h2 className="gl-modal-title gl-metal-text truncate">交易员配置</h2>
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            >
              <span
                ...
                style={{
                  background: traderData.is_running ? 'var(--binance-green)' : 'var(--binance-red)',
                }}
              />
        ...
        <div className="gl-modal-scroll dash-scroll p-6 space-y-5">
          ...
          <div className="gl-onyx-panel rounded-2xl overflow-hidden p-5">
            <h3 className="flex items-center gap-2.5 mb-4">
              ...
              <span className="text-base font-semibold gl-metal-shine">基础信息</span>
            </h3>
          ...
          {traderData.strategy_id && (
            <div className="gl-onyx-panel rounded-2xl overflow-hidden p-5">
              <h3 className="flex items-center gap-2.5 mb-4">
                ...
                <span className="text-base font-semibold gl-metal-shine">使用策略</span>
              </h3>
              <div className="space-y-1">
                <InfoRow
                  label="策略名称"
