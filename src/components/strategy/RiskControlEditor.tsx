...
import { Shield01Icon, AlertCircleIcon, Coins01Icon } from '@hugeicons/core-free-icons'
    ...
    <div className="space-y-7">
      ...
      <div className="gl-onyx-panel rounded-2xl overflow-hidden p-5">
        ...
        <div className="flex items-center gap-2 mb-3">
          <HugeiconsIcon icon={Coins01Icon} size={15} strokeWidth={1.9} style={{ color: 'var(--accent-primary)' }} />
        ...
        <div className="mb-3">
          <div className="flex items-center gap-2">
            <HugeiconsIcon icon={Shield01Icon} size={15} strokeWidth={1.9} style={{ color: 'var(--binance-green)' }} />
            <p className="text-xs font-semibold uppercase tracking-wide" style={{ color: 'var(--binance-green)' }}>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div
            ...
            style={{ boxShadow: '0 0 0 1px color-mix(in srgb, var(--binance-green) 45%, transparent) inset' }}
          >
            <label className="gl-field-label">{t('btcEthPositionValueRatio')}</label>
            <p className="gl-field-hint mb-3">{t('btcEthPositionValueRatioDesc')}</p>
            <div className="flex items-center gap-3">
              <input
                type="range"
          ...
          <div
            ...
            style={{ boxShadow: '0 0 0 1px color-mix(in srgb, var(--binance-green) 45%, transparent) inset' }}
          >
            <label className="gl-field-label">{t('altcoinPositionValueRatio')}</label>
            <p className="gl-field-hint mb-3">{t('altcoinPositionValueRatioDesc')}</p>
            <div className="flex items-center gap-3">
              <input
                type="range"
      ...
      <div className="gl-onyx-panel rounded-2xl overflow-hidden p-5">
        <div className="flex items-center gap-3 mb-5">
          <div className="dash-ico shrink-0">
            <HugeiconsIcon icon={AlertCircleIcon} size={18} strokeWidth={1.9} style={{ color: 'var(--binance-red)' }} />
          </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="gl-metal-panel rounded-xl overflow-hidden p-4">
            ...
            <div className="flex items-center gap-2">
              <span className="text-sm font-semibold tabular-nums" style={{ color: 'var(--text-secondary)' }}>1:</span>
              <input
                type="number"
          ...
          >
            ...
            <div className="flex items-center gap-3">
              <input
                ...
                style={{ accentColor: 'var(--binance-green)' }}
              />
              <span className="gl-metal-text w-12 text-center text-sm font-semibold tabular-nums" style={{ color: 'var(--binance-green)' }}>
      ...
      <div className="gl-onyx-panel rounded-2xl overflow-hidden p-5">
        <div className="flex items-center gap-3 mb-5">
          <div className="dash-ico shrink-0">
            <HugeiconsIcon icon={Shield01Icon} size={18} strokeWidth={1.9} style={{ color: 'var(--binance-green)' }} />
          </div>
