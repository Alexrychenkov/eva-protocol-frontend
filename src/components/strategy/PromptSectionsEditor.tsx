...
export function PromptSectionsEditor({
  ...
  const sections: { key: string; label: string; desc: string; icon: IconSvgElement }[] = [
    { key: 'role_definition', label: t('roleDefinition'), desc: t('roleDefinitionDesc'), icon: UserCircleIcon },
    { key: 'trading_frequency', label: t('tradingFrequency'), desc: t('tradingFrequencyDesc'), icon: Clock01Icon },
    { key: 'entry_standards', label: t('entryStandards'), desc: t('entryStandardsDesc'), icon: Target01Icon },
    { key: 'decision_process', label: t('decisionProcess'), desc: t('decisionProcessDesc'), icon: Notebook01Icon },
  ]
    ...
    <div className="space-y-4">
      <div className="flex items-start gap-3 mb-1">
        ...
        <div className="min-w-0">
          <h3 className="text-sm font-semibold uppercase tracking-wider gl-metal-shine" style={{ animationDelay: '-1.2s' }}>
            {t('promptSections')}
          </h3>
            ...
            <div key={key} className="gl-onyx-panel rounded-xl overflow-hidden">
              ...
              >
                ...
                <div className="flex items-center gap-2.5 shrink-0">
                  <span className="text-[10px] font-semibold uppercase tracking-wide tabular-nums" style={{ color: 'var(--text-tertiary)' }}>
                ...
                <div className="px-3.5 pb-3.5 pt-1">
                  ...
                  <div className="flex items-center justify-between gap-2 mt-2.5">
                    <span className="inline-flex items-center gap-1.5 text-[11px] font-medium" style={{ color: 'var(--text-tertiary)' }}>
                      {isModified ? (
                        <>
                          <HugeiconsIcon icon={CheckmarkCircle01Icon} size={13} strokeWidth={2} style={{ color: 'var(--accent-primary)' }} />
