...
import { Globe02Icon, SquareLock02Icon, ViewIcon, ViewOffSlashIcon } from '@hugeicons/core-free-icons'
            ...
            <div className="flex items-center gap-3 min-w-0">
              ...
              >
                <HugeiconsIcon
                  ...
                  size={20}
                  strokeWidth={1.9}
                  style={{ color: configVisible ? 'var(--accent-primary)' : 'var(--text-secondary)' }}
                />
              </div>
              <div className="min-w-0">
                <div className="text-sm font-semibold gl-metal-text truncate">
