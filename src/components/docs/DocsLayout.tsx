    ...
    >
      ...
      >
        ...
        <button
          ...
          style={{ color: 'var(--text-secondary)', background: 'var(--surface-secondary)', border: '1px solid var(--surface-tertiary)' }}
          onMouseEnter={(e) => { e.currentTarget.style.color = 'var(--accent-primary)'; e.currentTarget.style.borderColor = 'var(--accent-primary-border)' }}
          onMouseLeave={(e) => { e.currentTarget.style.color = 'var(--text-secondary)'; e.currentTarget.style.borderColor = 'var(--surface-tertiary)' }}
        >
          <ArrowLeft className="w-4 h-4" />
          <span className="hidden sm:inline">{language === 'zh' ? '返回' : 'Back'}</span>
        </button>

        <div className="h-5 w-px shrink-0" style={{ background: 'var(--surface-tertiary)' }} />
        ...
        <BookOpen className="w-5 h-5 hidden sm:block shrink-0" style={{ color: 'var(--accent-primary)' }} />
