...
import { ArrowRightLeft, Loader2, Lock, Send, Shield, Sparkles } from 'lucide-react'
...
export function UpgradeDeepThinkPanel({
  ...
  const t = language === 'zh'
    ? {
        ...
        placeholder: 'Ask EVA to bridge, swap, rebalance, or send to a whitelisted name…',
        send: 'Send',
        active: '已激活',
        bridge: '桥接工具',
        whitelist: '管理白名单',
    ...
    <div className="rounded-3xl p-5 sm:p-6 space-y-4 overflow-hidden gl-onyx-panel">
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
        <div className="w-full min-w-0">
          ...
          <p className="text-sm mt-2 whitespace-nowrap" style={{ color: 'var(--text-secondary)' }}>
            {t.description}
          </p>
        </div>
        ...
        <div
          ...
          style={{
            background: eligible ? 'rgba(16,203,129,0.10)' : 'rgba(255,255,255,0.035)',
        ...
        >
          ...
          <span className={`gl-gate-label${eligible ? ' gl-gate-label--unlocked' : ''}`}>
      ...
      <div className="flex flex-wrap items-center gap-2">
        <button
          ...
          style={{
            background: eligible ? 'rgba(61,107,255,0.12)' : 'rgba(255,255,255,0.04)',
