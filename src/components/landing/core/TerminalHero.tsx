...
export default function TerminalHero({ onProductChoice }: TerminalHeroProps) {
  ...
  const content = {
    en: {
      ...
      description: 'EVA combines autonomous AI trading with intelligent wallet analysis. Deploy LLM-driven agents across 10+ exchanges, or connect your wallet for AI insights on holdings, historical performance, and swap suggestions.',
    ...
    zh: {
      ...
      description: 'EVA 将自主 AI 交易与智能钱包分析融为一体。在 10+ 交易所部署 LLM 驱动的交易员，或连接钱包获取持仓分析、历史表现和兑换建议。',
      walletTitle: 'AI 钱包分析',
