    ...
    return (
        <section className="relative w-full min-h-screen bg-nofx-bg text-nofx-text overflow-hidden flex flex-col pt-16">
            ...
            <div className="w-full bg-nofx-gold text-black font-bold py-2 border-y border-black z-20">
                <Marquee speed={40}>
                    <span className="mx-8 text-sm md:text-base uppercase tracking-widest">EVA AI TRADING • AUTOMATED WEALTH • DECENTRALIZED INTELLIGENCE • PRECISION TRADING •</span>
                    <span className="mx-8 text-sm md:text-base uppercase tracking-widest">EVA AI TRADING • AUTOMATED WEALTH • DECENTRALIZED INTELLIGENCE • PRECISION TRADING •</span>
                </Marquee>
            </div>
                ...
                <div className="flex-1 flex flex-col justify-center px-6 lg:px-16 pt-12 lg:pt-0 relative z-20">
                    ...
                    >
                        ...
                        <p className="text-xl md:text-2xl text-zinc-400 max-w-[90vw] sm:max-w-xl mb-10 font-mono leading-relaxed">
                            ...
                            <span className="text-white font-bold ml-2 bg-nofx-accent px-2 py-0.5">TRADERS</span>.
                        </p>
