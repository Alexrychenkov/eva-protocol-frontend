...
export function AuthGatePage({ returnPath }: AuthGatePageProps) {
  const goTo = (path: string) => {
    if (returnPath) {
      try { sessionStorage.setItem('returnUrl', returnPath) } catch { /* storage blocked */ }
    }
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: 'radial-gradient(ellipse 60% 40% at 50% 30%, rgba(61,107,255,0.06) 0%, transparent 70%)',
        }}
      />
      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-sm w-full">
        ...
        <div
          ...
          style={{ background: 'rgba(61,107,255,0.1)', border: '1px solid rgba(61,107,255,0.2)' }}
        >
        ...
        <p className="text-sm leading-relaxed mb-8" style={{ color: 'rgba(255,255,255,0.45)' }}>
          This page requires an account. Sign in to your existing account or create a new one to continue.
        </p>
        ...
        <div className="flex flex-col gap-3 w-full">
          <button
            ...
            style={{ background: 'linear-gradient(135deg, #3d6bff 0%, #2a54e6 100%)', color: '#fff' }}
          >
