...
export function AdvancedChart({
  ...
  return (
    <div
      className="relative"
      style={{
        background: 'linear-gradient(180deg, rgba(20,26,40,0.55) 0%, rgba(10,13,22,0.35) 100%)',
        borderRadius: '16px',
        overflow: 'hidden',
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          background: 'linear-gradient(180deg, rgba(28,36,56,0.45) 0%, rgba(14,18,30,0.25) 100%)',
          flexShrink: 0,
        }}
      >
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            <span className="dash-ico" style={{ width: 26, height: 26 }}>
              <HugeiconsIcon icon={Analytics02Icon} size={15} strokeWidth={1.9} />
            </span>
            <span className="text-sm font-bold gl-metal-text tracking-wide">{symbol}</span>
            <span
            ...
            <span
              ...
              style={{
                background: exchange === 'hyperliquid' ? 'rgba(80, 227, 194, 0.10)' : 'rgba(61, 107, 255, 0.10)',
          ...
          {/* Price Display */}
          {marketStats && (
            <div className="flex items-center gap-3 pl-3" style={{ borderLeft: '1px solid rgba(120, 150, 255, 0.12)' }}>
              <span
                className="text-base font-bold tabular-nums"
                style={{ color: marketStats.priceChange >= 0 ? 'var(--binance-green)' : 'var(--binance-red)' }}
              >
              ...
              <span
                ...
                style={{
                  background: marketStats.priceChange >= 0 ? 'rgba(14, 203, 129, 0.12)' : 'rgba(246, 70, 93, 0.12)',
                  border: `1px solid ${marketStats.priceChange >= 0 ? 'rgba(14, 203, 129, 0.25)' : 'rgba(246, 70, 93, 0.25)'}`,
                  color: marketStats.priceChange >= 0 ? 'var(--binance-green)' : 'var(--binance-red)',
                }}
              >
                <HugeiconsIcon
                  icon={marketStats.priceChange >= 0 ? ArrowUpRight01Icon : ArrowDownRight01Icon}
                  size={12}
                  strokeWidth={2.2}
                />
              ...
              {/* Compact H/L */}
              <div className="flex items-center gap-3 text-[11px] tabular-nums" style={{ color: 'var(--text-tertiary)' }}>
                <span>H <span className="gl-metal-text font-semibold">{marketStats.high.toFixed(2)}</span></span>
                <span>L <span className="gl-metal-text font-semibold">{marketStats.low.toFixed(2)}</span></span>
                {marketStats.volume > 0 && baseUnit && (
                  <span>Vol <span className="gl-metal-text font-semibold">{formatVolume(marketStats.volume)}</span></span>
                )}
              </div>
            </div>
          )}
        ...
        <div className="flex items-center gap-1.5">
          ...
          <div className="gl-seg">
            ...
            >
              <HugeiconsIcon icon={Settings01Icon} size={13} strokeWidth={1.9} />
      ...
      {showIndicatorPanel && (
        <div
          ...
          style={{
            background: 'linear-gradient(180deg, rgba(24,30,46,0.96) 0%, rgba(13,17,28,0.96) 100%)',
        ...
        >
          ...
          >
            <div className="flex items-center gap-2">
              <span className="dash-ico" style={{ width: 26, height: 26 }}>
                <HugeiconsIcon icon={ChartBarLineIcon} size={15} strokeWidth={1.9} />
              </span>
          ...
          <div className="p-3 space-y-1">
            {indicators.map(indicator => (
              <label
                ...
                onMouseEnter={(e) => { e.currentTarget.style.background = 'rgba(120,150,255,0.06)'; e.currentTarget.style.borderColor = 'rgba(120,150,255,0.12)' }}
              ...
              >
                ...
                ></span>
                <span className="text-sm flex-1 tabular-nums" style={{ color: indicator.enabled ? 'var(--text-primary)' : 'var(--text-secondary)' }}>
                  {indicator.name}
                </span>
                {indicator.enabled && (
                  <span className="dash-live-dot" />
          ...
          <div
            ...
            style={{ color: 'var(--text-tertiary)', borderTop: '1px solid rgba(120, 150, 255, 0.10)' }}
          >
        ...
        {tooltipData && (
          <div
            ...
            style={{
              ...
              top: '10px',
              padding: '10px 13px',
              background: 'linear-gradient(180deg, rgba(24,30,46,0.92) 0%, rgba(13,17,28,0.92) 100%)',
          ...
          >
            <div style={{ marginBottom: '6px', color: '#7da0ff', fontWeight: 'bold', fontSize: '11px', letterSpacing: '0.5px' }}>
      ...
      {error && (
        <div
          ...
          style={{ background: 'linear-gradient(180deg, rgba(20,26,40,0.85) 0%, rgba(10,13,22,0.9) 100%)', backdropFilter: 'blur(4px)' }}
        >
          <div className="flex flex-col items-center text-center px-6">
            ...
            >
              <HugeiconsIcon icon={AlertCircleIcon} size={24} strokeWidth={1.9} />
            </span>
            <div className="text-sm font-medium" style={{ color: 'var(--binance-red)' }}>{error}</div>
          </div>
        </div>
      )}
