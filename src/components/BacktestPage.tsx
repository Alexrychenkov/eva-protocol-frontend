...
import { type ViewTab, type ToastPayload, SWR_OPTS } from './backtest/backtestShared'
...
export function BacktestPage() {
  ...
  const handleToast = useCallback((payload: ToastPayload) => setToast(payload), [])
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
          ...
          <BacktestResultsPanel
            selectedRunId={selectedRunId}
            onSelectRun={setSelectedRunId}
            onRunDeleted={(runId) => setCompareRunIds((prev) => prev.filter((id) => id !== runId))}
            viewTab={viewTab}
