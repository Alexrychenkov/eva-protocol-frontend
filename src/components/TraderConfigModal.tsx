...
const EXCHANGE_REGISTRATION_LINKS: Record<string, { url: string; hasReferral?: boolean }> = {
  binance: { url: 'https://www.binance.com/join?ref=EVAENG', hasReferral: true },
    ...
    <div className="gl-modal-overlay" onClick={onClose}>
      ...
      >
        ...
        <div className="gl-modal-scroll dash-scroll space-y-6">
          ...
          <div className="gl-onyx-panel rounded-2xl overflow-hidden p-5">
            <h3 className="text-base font-semibold gl-metal-shine mb-5 flex items-center gap-2.5">
              <span className="dash-ico shrink-0">
                <HugeiconsIcon icon={Settings01Icon} size={16} strokeWidth={1.9} />
              </span>
                ...
                <div>
                  ...
                  {formData.exchange_id && (() => {
                    ...
                    return (
                      ...
                      >
                        <HugeiconsIcon icon={UserAdd01Icon} size={14} strokeWidth={1.9} />
                        ...
                        <HugeiconsIcon icon={LinkSquare01Icon} size={12} strokeWidth={1.9} />
                      </a>
                    )
                  })()}
                </div>
          ...
          {/* Strategy Selection */}
          <div className="gl-onyx-panel rounded-2xl overflow-hidden p-5">
            <h3 className="text-base font-semibold gl-metal-shine mb-5 flex items-center gap-2.5" style={{ animationDelay: '-1.2s' }}>
              <span className="dash-ico shrink-0">
                <HugeiconsIcon icon={SparklesIcon} size={16} strokeWidth={1.9} />
              </span>
                ...
                <div className="mt-3 p-4 gl-metal-panel rounded-xl overflow-hidden">
                  ...
                  <div className="grid grid-cols-2 gap-2 text-xs">
                    <div className="flex items-center gap-1.5" style={{ color: 'var(--text-secondary)' }}>
                      <HugeiconsIcon icon={Coins01Icon} size={13} strokeWidth={1.9} className="shrink-0" style={{ color: 'var(--accent-primary)' }} />
                    ...
                    <div className="flex items-center gap-1.5 tabular-nums" style={{ color: 'var(--text-secondary)' }}>
                      <HugeiconsIcon icon={Target01Icon} size={13} strokeWidth={1.9} className="shrink-0" style={{ color: 'var(--accent-primary)' }} />
          ...
          {/* Trading Parameters */}
          <div className="gl-onyx-panel rounded-2xl overflow-hidden p-5">
            <h3 className="text-base font-semibold gl-metal-shine mb-5 flex items-center gap-2.5" style={{ animationDelay: '-2.4s' }}>
              <span className="dash-ico shrink-0">
                <HugeiconsIcon icon={Target01Icon} size={16} strokeWidth={1.9} />
              </span>
              ...
              <div>
                ...
                <div className="gl-seg">
                  <button
                    ...
                    className="gl-seg-item"
                    data-active={formData.show_in_competition ? 'true' : 'false'}
                  >
                    {t('show', language)}
                  </button>
                  <button
              ...
              {isEditMode && (
                <div>
                  <div className="flex items-center justify-between mb-2">
                    ...
                    >
                      <HugeiconsIcon icon={RefreshIcon} size={13} strokeWidth={1.9} className={isFetchingBalance ? 'animate-spin' : ''} />
        ...
        <div className="gl-modal-foot">
          ...
          {onSave && (
            ...
            >
              <HugeiconsIcon icon={isEditMode ? Wallet01Icon : Add01Icon} size={16} strokeWidth={1.9} />
