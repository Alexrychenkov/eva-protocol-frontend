...
const BENIGN = /insertBefore|removeChild|appendChild|NotFoundError|The node to be removed/i
...
function DefaultFallback({ error, reset }: { error: Error; reset: () => void }) {
  return (
    ...
    >
      ...
      >
        <div style={{ fontSize: 13, letterSpacing: '0.18em', textTransform: 'uppercase', color: 'rgba(16,185,129,0.9)', fontWeight: 800 }}>
          Something broke on this page
        </div>
        <p style={{ marginTop: 10, fontSize: 14, lineHeight: 1.5, color: 'rgba(255,255,255,0.62)' }}>
          The rest of the app is fine — only this view hit an error. You can retry it
