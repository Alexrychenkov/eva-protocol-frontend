...
const PLATFORM: NavGroup = {
  ...
  columns: 2,
  items: [
    { page: 'trader',          path: '/dashboard',       icon: DashboardSquare01Icon, requiresAuth: true,
      label: 'Dashboard',       zh: '仪表盘',   desc: 'AI trader performance at a glance', descZh: 'AI 交易员表现概览' },
    { page: 'traders',         path: '/traders',         icon: Robot01Icon,           requiresAuth: true,
      label: 'AI Traders',      zh: 'AI 交易员', desc: 'Configure & manage your agents',    descZh: '配置和管理 AI 交易代理' },
    { page: 'strategy',        path: '/strategy',        icon: Target01Icon,          requiresAuth: true,
      label: 'Strategies',      zh: '策略',     desc: 'Build & tune trading strategies',   descZh: '创建和管理交易策略' },
    { page: 'strategy-market', path: '/strategy-market', icon: Store01Icon,           requiresAuth: true,
      label: 'Strategy Market', zh: '策略市场', desc: 'Browse the community marketplace',  descZh: '浏览社区策略' },
    { page: 'backtest',        path: '/backtest',        icon: TestTube01Icon,        requiresAuth: true,
      label: 'Backtest',        zh: '回测',     desc: 'Test against historical data',      descZh: '针对历史数据测试策略' },
    { page: 'competition',     path: '/competition',     icon: Award01Icon,           requiresAuth: true,
      label: 'Live Competition',zh: '实时排行', desc: 'Real-time trader leaderboard',      descZh: '实时 AI 交易员排行榜' },
    { page: 'debate',          path: '/debate',          icon: BubbleChatIcon,        requiresAuth: true,
      label: 'AI Debate',       zh: 'AI 辩论',  desc: 'Watch agents debate the market',    descZh: '观看 AI 交易员实时辩论市场走势' },
  ],
}
...
const TOKEN: NavGroup = {
  ...
  columns: 1,
  items: [
    { page: 'tokenomics', path: '/tokenomics', icon: Coins01Icon,  label: 'Tokenomics', zh: '代币经济',
      desc: 'Supply, allocation & utility', descZh: '供应、分配与用途' },
    { page: 'upgrade',    path: '/upgrade',    icon: Rocket01Icon, label: 'Upgrade',    zh: '升级',
      desc: 'Unlock premium plans',         descZh: '解锁高级套餐' },
  ],
}

// ── Standalone links (no dropdown) ───────────────────────────────────────────
const MARKETS: NavLeaf = {
  page: 'data', path: '/data', icon: Analytics02Icon, label: 'Markets', zh: '市场',
  desc: 'Live market data & analytics', descZh: '实时市场数据与分析',
}
const DOCS: NavLeaf = {
  page: 'faq', path: '/faq', icon: Book02Icon, label: 'Docs', zh: '文档',
  desc: 'Guides & documentation', descZh: '指南与文档',
}
