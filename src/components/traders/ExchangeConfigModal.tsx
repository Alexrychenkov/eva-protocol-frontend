...
import {
  BookOpen01Icon, Delete02Icon, HelpCircleIcon, LinkSquare01Icon, UserAdd01Icon,
  Cancel01Icon, ArrowLeft01Icon, CheckmarkCircle01Icon, Copy01Icon, ArrowRight01Icon,
  Shield01Icon, Wallet01Icon, Key01Icon,
    ...
    <div className="gl-modal-overlay" onClick={onClose}>
      ...
      >
        ...
        <div className="gl-modal-head">
          ...
          <div className="flex items-center gap-2">
            ...
            {editingExchangeId && (
              ...
              >
                <HugeiconsIcon icon={Delete02Icon} size={18} strokeWidth={1.9} />
              </button>
            )}
            <button
              type="button"
        ...
        <div
          ...
          style={{ background: 'rgba(14, 203, 129, 0.06)', borderBottom: '1px solid var(--panel-border)' }}
        >
          <HugeiconsIcon icon={Shield01Icon} size={14} strokeWidth={1.9} style={{ color: 'var(--binance-green)' }} />
                ...
                <div className="gl-onyx-panel rounded-xl overflow-hidden">
                  {cexExchanges.map((template, i) => (
                    <button
                      ...
                      style={{ borderTop: i > 0 ? '1px solid var(--panel-border)' : undefined }}
                    >
                      ...
                      <HugeiconsIcon icon={ArrowRight01Icon} size={16} strokeWidth={1.9} className="shrink-0" style={{ color: 'var(--text-tertiary)' }} />
                    </button>
                  ))}
                </div>
              </div>
              ...
              <div className="gl-metal-panel flex items-center justify-between p-3 rounded-xl overflow-hidden">
                ...
                <div className="flex items-center gap-2">
                  {currentExchangeType === 'binance' && (
                    ...
                    >
                      <HugeiconsIcon icon={BookOpen01Icon} size={16} strokeWidth={1.9} />
                    </button>
                  )}
                  <a
                  ...
                  >
                    <HugeiconsIcon icon={UserAdd01Icon} size={13} strokeWidth={1.9} />
                      ...
                      {showBinanceGuide && (
                        <div className="mt-2 pt-2 text-xs" style={{ borderTop: '1px solid rgba(234, 179, 8, 0.15)', color: 'var(--text-secondary)' }}>
                          <a
                            ...
                            onClick={(e) => e.stopPropagation()}
                          >
                            {language === 'zh' ? '查看官方教程' : 'View Tutorial'} <HugeiconsIcon icon={LinkSquare01Icon} size={13} strokeWidth={1.9} />
                          </a>
                        </div>
                      )}
                    </div>
                      ...
                      {loadingIP ? (
                        ...
                        <div className="flex items-center gap-2">
                          <code
                            ...
                            style={{ background: 'rgba(10, 12, 18, 0.7)', border: '1px solid var(--panel-border)', color: 'var(--accent-primary)' }}
                          >
                            {serverIP.public_ip}
                          </code>
                          <button
                          ...
                          >
                            {copiedIP
                              ? <HugeiconsIcon icon={CheckmarkCircle01Icon} size={13} strokeWidth={1.9} style={{ color: 'var(--binance-green)' }} />
                  ...
                  <div className="space-y-1.5">
                    <label className="gl-field-label flex items-center gap-1.5">
                      ...
                      <Tooltip content={t('asterUserDesc', language)}>
                        <HugeiconsIcon icon={HelpCircleIcon} size={14} strokeWidth={1.9} className="cursor-help" style={{ color: 'var(--text-tertiary)' }} />
                      </Tooltip>
                    </label>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="flex gap-2">
                      ...
                      >
                        <HugeiconsIcon icon={Key01Icon} size={14} strokeWidth={1.9} />
              ...
              >
                ...
                >
                  {isSaving ? (t('saving', language) || 'Saving...') : (
                    <>{t('saveConfig', language)} <HugeiconsIcon icon={ArrowRight01Icon} size={15} strokeWidth={1.9} /></>
                  )}
                </button>
              </div>
            </form>
      ...
      {showGuide && (
        <div className="gl-modal-overlay" onClick={() => setShowGuide(false)}>
          <div className="gl-modal-panel gl-glow-border max-w-4xl max-h-[90vh] overflow-hidden" onClick={(e) => e.stopPropagation()}>
            <div className="gl-modal-head">
              <span className="dash-ico">
                <HugeiconsIcon icon={BookOpen01Icon} size={16} strokeWidth={1.9} />
              </span>
              ...
              <button onClick={() => setShowGuide(false)} className="gl-modal-close" aria-label={language === 'zh' ? '关闭' : 'Close'}>
                <HugeiconsIcon icon={Cancel01Icon} size={18} strokeWidth={1.9} />
              </button>
            </div>
