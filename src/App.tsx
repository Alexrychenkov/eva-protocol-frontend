import { useEffect, useState, lazy, Suspense, startTransition, type ComponentType } from 'react'
...
const TraderDashboardPage = lazyWithReload(() => import('./pages/TraderDashboardPage').then((m) => ({ default: m.TraderDashboardPage })))
const AITradersPage = lazyWithReload(() => import('./components/AITradersPage').then((m) => ({ default: m.AITradersPage })))
const LoginPage = lazyWithReload(() => import('./components/LoginPage').then((m) => ({ default: m.LoginPage })))
const RegisterPage = lazyWithReload(() => import('./components/RegisterPage').then((m) => ({ default: m.RegisterPage })))
const ResetPasswordPage = lazyWithReload(() => import('./components/ResetPasswordPage').then((m) => ({ default: m.ResetPasswordPage })))
const CompetitionPage = lazyWithReload(() => import('./components/CompetitionPage').then((m) => ({ default: m.CompetitionPage })))
const LandingPage = lazyWithReload(() => import('./pages/LandingPage').then((m) => ({ default: m.LandingPage })))
const TradePage = lazyWithReload(() => import('./pages/TradePage').then((m) => ({ default: m.TradePage })))
const TokenomicsPage = lazyWithReload(() => import('./pages/TokenomicsPage').then((m) => ({ default: m.TokenomicsPage })))
const UpgradePage = lazyWithReload(() => import('./pages/UpgradePage').then((m) => ({ default: m.UpgradePage })))
const DocsPage = lazyWithReload(() => import('./pages/DocsPage').then((m) => ({ default: m.DocsPage })))
const StrategyStudioPage = lazyWithReload(() => import('./pages/StrategyStudioPage').then((m) => ({ default: m.StrategyStudioPage })))
const DebateArenaPage = lazyWithReload(() => import('./pages/DebateArenaPage').then((m) => ({ default: m.DebateArenaPage })))
const StrategyMarketPage = lazyWithReload(() => import('./pages/StrategyMarketPage').then((m) => ({ default: m.StrategyMarketPage })))
const DataPage = lazyWithReload(() => import('./pages/DataPage').then((m) => ({ default: m.DataPage })))
const AuthGatePage = lazyWithReload(() => import('./components/AuthGatePage').then((m) => ({ default: m.AuthGatePage })))
const BacktestPage = lazyWithReload(() => import('./components/BacktestPage').then((m) => ({ default: m.BacktestPage })))
...
function App() {
  ...
  useEffect(() => {
    ...
    try { sessionStorage.removeItem('eva:chunk-reloaded') } catch { /* ignore */ }
  }, []);
